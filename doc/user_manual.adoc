...
tailoring of an XCCDF 1.1 file might not work scanners other than openscap.
****
...
Pressing *Report* will bring up a new window called Evaluation Report.
In case scap-workbench was compiled with WebKit support you should see
the HTML report right in the application. Otherwise, press *Open in Browser*
to open the report using your internet browser.
