...
In case the tailoring action will create a new profile you will be presented
...
Click *Save Tailoring* and choose the destination file. Workbench saves just the
tailored changes, which you can use with the content you opened.
...
directory, scap-workbench exports both input content and a tailoring file into the
directory.
