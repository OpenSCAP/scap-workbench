...
class Imp_CVE_to_treeModelList:
	...
	def __init__(self,widget_tree,widget_text,imp_cve):
		...
		# column for id - cve
		column = gtk.TreeViewColumn('CVE ID', gtk.CellRendererText(),text=0)
	...
	# renderer column for score
	def entry_score(self, column, cell, model, iter):
		score =  model.get_value(iter, 3)
...
class Entry_to_text:
	...
	def __init__(self,widget_text):
		...
		# nastaveni zalamovani radku na sloav pokud je okno vetsi
