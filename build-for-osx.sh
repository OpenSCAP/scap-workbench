mkdir -p build-osx/
pushd build-osx/
cmake -D SCAP_WORKBENCH_LOCAL_SCAN_ENABLED=false -D SETSID_EXECUTABLE="@executable_path/setsid" -D SCAP_WORKBENCH_SSG_DIRECTORY="@executable_path/../Resources/ssg" -D SCAP_WORKBENCH_SCAP_CONTENT_DIRECTORY="~/" ../
make -j 4
